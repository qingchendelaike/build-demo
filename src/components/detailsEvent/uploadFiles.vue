<template>
  <div class="uploadFiles">
    <div class="status">
      ...
      <div
        v-if="detailsData.item_status == 1 || detailsData.item_status==2 || detailsData.item_status ==3"
      >
        <el-popover placement="left-start" popper-class="transferDia" v-model="dialogVisible">
          ...
          <p
            ...
            style="width: 100%;color: red;text-align: center;margin-top: 10px;"
          ...
          <span
            class="statusRed"
            v-if="detailsData.is_self || detailsData.is_special"
            slot="reference"
            @click="itemUserLists"
          >催办</span>
        </el-popover>
      ...
      <div class="meeting">
        ...
        >
          <p class="upFiles">
            ...
            <span>上传文件</span>
            <input type="file" @change="upFiles($event,item)" />
          </p>
        </div>
      </div>
    ...
    <div
      ...
      v-if="detailsData.item_status == 1 || detailsData.item_status==2 || detailsData.item_status ==3"
    >
      <el-popover placement="top" v-model="finisVisible">
        <h3>确认办结</h3>
        ...
        <el-button
          ...
          type="primary"
          v-show="detailsData.is_special"
          :disabled="detailsData.item_status == 4"
        >{{detailsData.item_status == 4 ?'已办结':'办结事项'}}</el-button>
      </el-popover>
    </div>
  </div>
</template>
  ...
  .meeting {
    ...
    .upFiles {
      ...
      .meetIcon {
        width: 20px;
        height: 20px;
        background: url("../../assets/img/css_sprites.png") -183px -78px
          no-repeat;
      }
